...
from ..augmentations import autocontrast, equalize, posterize, rotate, solarize, shear_x, shear_y, translate_x, translate_y
...
class Policy(nn.Module):
    ...
    def dda_operations():
        ...
        #return [autocontrast, equalize, posterize, rotate, solarize, shear_x, shear_y, translate_x, translate_y]
        return [
            #ShearX(),
            #ShearY(),
            TranslateX(),
