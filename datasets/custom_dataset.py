...
class CustomDataset(object):
    def __init__(self, dataroot='', use_gpu=True, num_workers=1, batch_size=128, _transforms='', _eval=False, input_size=224, alb_policy=None):
        ...
        testset = ImageFolder(root=dataroot['test'], transform=test_transform)
        ...
        if _eval:
            ...
            evalset = ImageFolder(root=dataroot['eval'], transform=test_transform)
        
            self.out_loaders = torch.utils.data.DataLoader(
